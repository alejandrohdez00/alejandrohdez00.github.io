...
<div style="display: flex; flex-direction: row; justify-content: space-between; margin: 20px 0;">
  <div style="flex: 1; margin-right: 10px;">
    <img src="/assets/images/dadaism_1.png" alt="compression" style="width: 100%; height: auto;">
